...
class WeekJsonTest {
  ...
  @Test
  void toWeek() {
    Week week3 = week1.toWeek();
    assertThat(week3).usingRecursiveComparison().isEqualTo(week2);
  }

  @Test
  void notes() {
    assertEquals("week1", week1.notes());
  }

  @Test
  void days() {
    assertEquals(days1, week1.days());
  }

  @Test
  void maxEvents() {
    assertEquals(10, week1.maxEvents());
  }

  @Test
  void maxTasks() {
    assertEquals(10, week1.maxTasks());
  }

  @Test
  void password() {
    assertEquals("password", week1.password());
  }
}